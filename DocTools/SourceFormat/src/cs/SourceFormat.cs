...
/*
 * Changes made by Robin Boerdijk:
 *
 *   1. Added Main method.
 *
 *   2. Replaced .csharpcode by .src
 */
...
namespace Manoli.Utils.CSharpFormat
{
	...
	/// .src, pre, .rem, .kwrd, .str, .op, .preproc, .alt, .lnum.
	/// </para>
	/// <para>
	...
	public abstract class SourceFormat
	{
		...
		/// characters. The default is <b>8</b>, unless overridden is a 
		/// derived class.</value>
			...
			bool alternate, bool embedStyleSheet, bool subCode)
		{
			...
			{
			    	sb.Append("<link rel=\"stylesheet\" href=\"SourceFormat.css\" type=\"text/css\">");
			}
